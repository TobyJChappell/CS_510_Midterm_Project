...
```{r DonorSearch Insights Images, echo=FALSE, out.width = '100%'}
...
## Results
As previously mentioned, the output of the code is a series of images which can be compiled into an animation. The result is in the Animation folder.
