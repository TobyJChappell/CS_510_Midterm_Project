...
## Results
As previously mentioned, the output of the code is a series of images which can be compiled into an animation. @ImageJ The result is in the Animation folder.
